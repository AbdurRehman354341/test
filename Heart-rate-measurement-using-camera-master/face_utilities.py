...
class Face_utilities():
    ...
    def get_landmarks(self, frame, type):
        ...
        if self.predictor is None:
            ...
            self.predictor = dlib.shape_predictor("E:\Heart-rate-measurement-using-camera-master\Heart-rate-measurement-using-camera-master\shape_predictor_5_face_landmarks.dat")
