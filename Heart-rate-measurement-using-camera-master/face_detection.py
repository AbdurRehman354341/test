...
class FaceDetection(object):
    def __init__(self):
        ...
        self.predictor = dlib.shape_predictor("E:\Heart-rate-measurement-using-camera-master\Heart-rate-measurement-using-camera-master\shape_predictor_68_face_landmarks.dat")
